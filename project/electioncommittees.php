...
$selectQuery = "SELECT * FROM electioncommitte_form";
...
<div class="container">
    ...
    <div style="text-align: center;">
        <button class="btn" onclick="alert('Thanks for viewing the Election Committees!')">Msg</button>
    </div>
