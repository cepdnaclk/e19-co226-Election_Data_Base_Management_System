...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($conn->connect_error) {
        ...
        $stmt = $conn->prepare("INSERT INTO participation(election_id, party_name, party_id) VALUES(?, ?, ?)");
        $stmt->bind_param("isi", $election_id, $party_name, $party_id);
        ...
        echo "<p>The Party Competed in the Election: <span class='highlight'>$party_name</span></p>";
        ...
        echo "<a href='participation.html'><button>Form</button></a>"; // Form button
        echo "</div>";
        echo "</div>";
        echo "</body>";
        echo "</html>";
